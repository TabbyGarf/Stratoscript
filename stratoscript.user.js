...
( function () {
    ...
    function antiPute() {
        ...
        document.querySelectorAll('td.topics-title a').forEach(function(a) {
            ...
            let strippedText = originalText.replace(/[\uD800-\uDFFF]./g, '');
